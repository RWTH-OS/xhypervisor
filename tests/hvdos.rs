...
fn vm_create() {
  unsafe {
    ...
    wvmcs(vcpu, VMCS_CTRL_PIN_BASED as u32, cap2ctrl(vmx_cap_pinbased, 0));
    wvmcs(vcpu, VMCS_CTRL_CPU_BASED as u32, cap2ctrl(vmx_cap_procbased,
                                                   VMCS_PRI_PROC_BASED_CTLS_HLT |
                                                   VMCS_PRI_PROC_BASED_CTLS_CR8_LOAD |
                                                   VMCS_PRI_PROC_BASED_CTLS_CR8_STORE));
    wvmcs(vcpu, VMCS_CTRL_CPU_BASED2 as u32, cap2ctrl(vmx_cap_procbased2, 0));
    wvmcs(vcpu, VMCS_CTRL_VMENTRY_CONTROLS as u32, cap2ctrl(vmx_cap_entry, 0));
